      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto p-0">
        ...
        <div className="bg-[#0d1b2a] text-white px-6 py-5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-xl font-bold tracking-tight text-primary">TransBH</div>
              <div className="text-[10px] uppercase tracking-[0.2em] text-white/60">Transporte de Veículos</div>
            </div>
          </div>
