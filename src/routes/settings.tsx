...
const VARS_BY_KEY: Record<string, string[]> = {
  ...
  wa_status_aguardando_coleta: ["client_name", "transport_code", "vehicle_plate", "company_name"],
  wa_status_coletado_aguardando_embarque: ["client_name", "transport_code", "vehicle_plate", "company_name"],
  wa_status_veiculo_patio_aguardando_retirada: ["client_name", "transport_code", "vehicle_plate", "company_name"],
  wa_status_finalizado: ["client_name", "transport_code", "vehicle_plate", "company_name", "review_link"],
